...
// Displays all movies the user has saved to their watchlist.
// If no movies have been saved yet, it shows an empty state
// with a link to start searching for movies.
