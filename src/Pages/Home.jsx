...
function Home() {
  return (
    <section className="min-h-[80vh] flex flex-cols items-center justify-center text-center px-4">
        <h1 className="text-4xl md:text-6xl font-bold text-slate-900 tracking-tight">Movie Explorer Pro</h1>
